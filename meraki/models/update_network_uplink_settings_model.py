...
import meraki.models.bandwidth_limits5_model
...
class UpdateNetworkUplinkSettingsModel(object):
    ...
    Attributes:
        bandwidth_limits (BandwidthLimits5Model): A mapping of uplinks
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = meraki.models.bandwidth_limits5_model.BandwidthLimits5Model.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
